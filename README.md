# Utang-Kantin-Manager
Script Bash untuk mencatat utang kantin dan rokok, mendukung mata uang Indonesia (IDR) dan Malaysia (MYR). Created by Laksamana Dzu Nur Ain.  hanya untuk orqang yg mqalaqs catat lewat buku  
...
- **🕒 Tanggal Fleksibel**: Bisa menggunakan tanggal otomatis sistem atau input manual.
- **🗑️ Manajemen Data**: Fitur untuk melihat, menghapus satu catatan, atau menghapus seluruh database.
- **🛠️ Auto Install**: Fitur install dependencies (`bc`, `nano`) langsung dari menu.
